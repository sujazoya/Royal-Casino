...
public class GameControl : MonoBehaviour {
    ...
    public Transform platformPrefabSmall;
	...
	void Awake () {
        ...
        StartGame();
        if (gameover_Panel) { gameover_Panel.SetActive(false); }
    }
    ...
    void GameOver()
    {
        ...
        if (gameover_Panel) { gameover_Panel.SetActive(true); }
    ...
    void SpawnPlatforms(float upTo)
    {
        ...
        while (spawnHeight <= upTo)
        {
            ...
            {
                 plat = (Transform)Instantiate(platformPrefabSmall, pos, Quaternion.identity);
            }
